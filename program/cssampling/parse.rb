...
class MyConst
  def initialize(body)
    ...
    #  ".mln" file constants
    # @name["Level_500"] = @name.size
    # @name["Level_100"] = @name.size
    # @name["Year_1"] = @name.size
    # @name["Year_2"] = @name.size
    # @name["Pre_Quals"] = @name.size
    # @name["Post_Quals"] = @name.size
    # @name["Post_Generals"] = @name.size
    # @name["Faculty"] = @name.size
    # @name["Faculty_affiliate"] = @name.size
    # @name["Faculty_adjunct"] = @name.size
    # @name["Faculty_emeritus"] = @name.size
    # @name["Faculty_visiting"] = @name.size
    # printf("default constant: %d\n",@name.size);
...
class MySmoking
  ...
  def p_atom
    @cnt += 1
    printf("rule:%2d , atom:%5d,  clause:%5d\n",@cnt,@vars.size,@cls.size)
  end
  ...
  def add_rule21(name)
    ...
    id4 = get_id(var4); id5 = get_id(var5); id6 = get_id(var6)
    cl = [-id1, id2, id3, id4, id5, id6]
    #id1 = get_id(var1); id2 = get_id(var2); id5 = get_id(var5); id4 = get_id(var4)
    #cl = [-id1, id2, id5]
    @cls.push(cl)
  end
